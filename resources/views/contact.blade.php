...
<html lang="en">
    ...
    <body>
       ...
       <div id="preloader">
        ...
        <!--================Banner Area =================-->
        <section class="banner_area_contact">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="contact_details">
                            <h3 class="contact_title">Let's Linkup</h3>
                            <p>We will love to hear from you. Contact us using the options below, send us email, call us or pass by any time between 7am and 5pm everyday for simply good food</p>
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4>Adderess</h4>
                                    <h5>University of Education,Winneba. North Campus,Winneba, C/R</h5>
                                </div>
                            </div>
                            <div class="media">
                                <div class="media-left">
                                ...
                                <div class="media-body">
                                    <h4>Phone</h4>
                                    <h5>+233 026 784 4749</h5>
                                    <h5>+233 024 441 7022</h5>
                                </div>
                            </div>
                            <div class="media">
                                <div class="media-left">
                                ...
                                <div class="media-body">
                                    <h4>Email</h4>
                                    <h5><a class="btn btn-danger" href="mailto:fpurestaurant.com">desk.fpurestaurant@gmail.com</a></h5>
                                </div>
                                ...
                                <div class="media-body">
                                    <h4>website</h4>
                                    <h5>www.fpurestaurantuew.com</h5>
                                </div>
                            </div>
                        </div>
